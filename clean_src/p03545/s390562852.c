...
static bool inFromS[200000], outForG[200000];
...
int main(void) {
    ...
    const int64_t A = (int64_t)(s[0] - '0');
    const int64_t B = (int64_t)(s[1] - '0');
    const int64_t C = (int64_t)(s[2] - '0');
    const int64_t D = (int64_t)(s[3] - '0');
    char sig[3];
    ...
    for (size_t a = 0; a < 2; a++) {
        ...
        for (size_t b = 0; b < 2; b++) {
            ...
            for (size_t c = 0; c < 2; c++) {
                ...
                if (sum == 7) {
                    printf("%"PRId64"%c%"PRId64"%c%"PRId64"%c%"PRId64"=7\n", A, sig[0], B, sig[1], C, sig[2], D);
