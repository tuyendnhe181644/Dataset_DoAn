...
int main(){
  ...
  char S[3];
  scanf("%s",S);
  if(S[0]=='S'&&S[1]=='U'&&S[2]=='N')ans=7;
  if(S[0]=='M'&&S[1]=='O'&&S[2]=='N')ans=6;
  if(S[0]=='T'&&S[1]=='U'&&S[2]=='E')ans=5;
  if(S[0]=='W'&&S[1]=='E'&&S[2]=='D')ans=4;
  if(S[0]=='T'&&S[1]=='H'&&S[2]=='U')ans=3;
  if(S[0]=='F'&&S[1]=='R'&&S[2]=='I')ans=2;
  if(S[0]=='S'&&S[1]=='A'&&S[2]=='T')ans=1;
