...
int main(){
  ...
  FOR(i,0,N)FOR(j,0,3)FOR(k,0,3){
    if(A[j][k]==b[i])a[j][k]=1;
  }
  FOR(i,0,3){
    if(a[i][0]==1&&a[i][1]==1&&a[i][2]==1)ans=1;
    if(a[0][i]==1&&a[1][i]==1&&a[2][i]==1)ans=1;
  }
  if(a[0][0]==1&&a[1][1]==1&&a[2][2]==1)ans=1;
  if(a[2][0]==1&&a[1][1]==1&&a[0][2]==1)ans=1;
  YN(ans);
