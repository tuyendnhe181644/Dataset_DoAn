	...
	if (k == 0) {
		...
		while (k) {
			if (k % 2) {
				for (i = 0; i < 2; i++) {
					for (j = 0; j < 2; j++) {
						tmp[i][j] = (x[i][0] * mat[0][j] + x[i][1] * mat[1][j]) % MOD;
					}
				}
				for (i = 0; i < 2; i++) {
					for (j = 0; j < 2; j++) {
			...
			for (i = 0; i < 2; i++) {
				for (j = 0; j < 2; j++) {
					tmp[i][j] = (mat[i][0] * mat[0][j] + mat[i][1] * mat[1][j]) % MOD;
				}
			}
			for (i = 0; i < 2; i++) {
				for (j = 0; j < 2; j++) {
