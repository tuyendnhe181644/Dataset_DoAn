...
int main(void){
    ...
    //     cin(&[i]);
    // }
    if(n%10==0){printf("pon\n");}
    if(n%10==1){printf("pon\n");}
    if(n%10==2){printf("hon\n");}
    if(n%10==3){printf("bon\n");}
    if(n%10==4){printf("hon\n");}
    if(n%10==5){printf("hon\n");}
    if(n%10==6){printf("pon\n");}
    if(n%10==7){printf("hon\n");}
    if(n%10==8){printf("pon\n");}
    if(n%10==9){printf("hon\n");}
    // if(n%10==8){printf("pon\n");}
