...
int main() {
	...
	scanf("%d", &X);
	if (X < 400);
	else if (X < 600) printf("8\n");
	else if (X < 800) printf("7\n");
	else if (X < 1000) printf("6\n");
	else if (X < 1200) printf("5\n");
	else if (X < 1400) printf("4\n");
	else if (X < 1600) printf("3\n");
	else if (X < 1800) printf("2\n");
	else if (X < 2000) printf("1\n");
	return 0;
}
