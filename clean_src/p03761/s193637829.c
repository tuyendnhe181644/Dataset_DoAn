...
int64_t a3_i = 0;
while ((a3_i <= (a3_n - 1))) {
*(&((&a3_s)->data[a3_i])) = stdio_read_stringGG_();
;
(a3_i += 1);
};
...
{
int64_t a3_x = 0;
while ((a3_x <= (core_string_lengthGG_core_string_String(*(&((&a3_s)->data[a3_i]))) - 1))) {
(*(&((&a3_curstore)->data[((int64_t)(core_string_getGG_core_string_String_core_prelude_Int(*(&((&a3_s)->data[a3_i])), a3_x)))])) += 1);
;
(a3_x += 1);
};
...
int64_t a3_x = 0;
while ((a3_x <= (255 - 1))) {
if ((*(&((&a3_store)->data[a3_x])) < *(&((&a3_curstore)->data[a3_x])))) {
*(&((&a3_store)->data[a3_x])) = *(&((&a3_store)->data[a3_x]));
} else {
*(&((&a3_store)->data[a3_x])) = *(&((&a3_curstore)->data[a3_x]));
};
(a3_x += 1);
};
...
{
int64_t a3_x = 1;
while ((a3_x <= *(&((&a3_store)->data[a3_i])))) {
core_string_pushGG_core_string_String_core_prelude_Char(&a3_ret, ((char)(a3_i)));
;
(a3_x += 1);
};
