...
static char maxC(const char* str, const uint64_t d) {
    char m = 'a' - 1;
...
static void su(char* str, const uint64_t d, const uint64_t len) {
    const uint64_t m = maxC(str, d);
