...
int avsortfnc(const void *a,const void *b){
if(((sd*)a)->av < ((sd*)b)->av){return -1;}
if(((sd*)a)->av > ((sd*)b)->av){return 1;}
return 0;
}

int bvsortfnc(const void *a,const void *b){
if(((sd*)a)->bv < ((sd*)b)->bv){return -1;}
if(((sd*)a)->bv > ((sd*)b)->bv){return 1;}
return 0;
}

int tesortfnc(const void *a,const void *b){
if(((sd*)a)->te < ((sd*)b)->te){return -1;}
if(((sd*)a)->te > ((sd*)b)->te){return 1;}
return 0;
}

long long kind(long long a[],long long n){
  long long r=n,i;
...
int main(void){
    resuf();
    long long a,b,p,i,j,n,r=0,st,aa[524288]={0},ba[524288]={0};
    scanf("%lld",&n);
    for(i=1;i<=n;i++){
      scanf("%lld%lld",&a,&b);
      uni(a,100000+b);
