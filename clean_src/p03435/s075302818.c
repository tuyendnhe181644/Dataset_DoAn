...
int main(void){
    ...
    long a[3]={0};
    for(loop1=0;loop1<3;loop1++){
        a[loop1]=sel_min(sel_min(data[loop1][0],data[loop1][1]),data[loop1][2]);
        //printf("%d ",a[loop1]);
    }
    for(loop1=0;loop1<3;loop1++){
        //printf("%ld %ld %ld\n",data[0][loop1]-a[0],data[1][loop1]-a[1],data[2][loop1]-a[2]);
        if(!(data[0][loop1]-a[0]==data[1][loop1]-a[1] && data[1][loop1]-a[1]==data[2][loop1]-a[2])){
            flag=0;
        }
    }
    if(flag){
