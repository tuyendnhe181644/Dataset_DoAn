...
double POW_double(double a, double b){double c=1;rep(i,0,b) c*=a;return c;}
...
ld sin_degree( double degree ){
    return sinl( PI * degree /180 );
}
ld cos_degree( double degree ){
    return cosl( PI * degree /180 );
}
ld tan_degree( double degree ){
    return tanl( PI * degree /180 );
}

// 1:sin 2:cos 3:tan
// ld s_c_t_deg( double degree , ll type ){
//     return (type==1) ? sinl( PI * degree /180 ) : (type==2) ? cosl( PI * degree /180 ) : tanl( PI * degree /180 ) ;
// }
...
int main(void){
    ...
    // printf("%.8Lf\n", a*b*sinl(  PI*c/180 )/2  );
    printf("%.8Lf\n", a*b* sin_degree(c)/2  );
    printf("%.8Lf\n", (ld) (a+b)+ sqrt( POW_double( b*sin_degree(c) ,2 ) + POW_double( a-b*cos_degree(c) ,2 ) ) );
    printf("%.8Lf\n", b*sin_degree(c) );
    // printf("%.8Lf\n", sinl(PI*c/180) );
    // printf("%.8Lf\n", sinl( PI/2 ) );
    return 0;
