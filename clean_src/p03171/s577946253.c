...
void dfs(ll l, ll r, ll taro){
    ...
    dfs(l,r-1,taro^1);
    if(taro){
        dp[l][r]=max2(dp[l+1][r]+a[l],dp[l][r-1]+a[r]);
    }else{
        dp[l][r]=min2(dp[l+1][r]-a[l],dp[l][r-1]-a[r]);
        // dp[l][r]=min2(dp[l][r],-dp[l][r-1]+a[r]);
        // dp[l][r]=min2(dp[l][r],-dp[l+1][r]+a[l]);
    }
        d[l][r]=1;
