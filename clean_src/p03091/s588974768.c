...
long long forv;
void rep(long long ver,bool fl[],rs g[],mkj x[]){
  long long i;
  if(fl[ver]==1){return;}
  fl[ver]=1;
  if(ver==forv){return;}
...
int main(void){
  long long i,j,n,m,k,a,b[262144]={0},c,h,w,r=0,l,t;
  sd arr[262144];
  rs g[262144];
  mkj x[262144];
  bool fl[262144]={0};
  ...
  qsort(arr,n,sizeof(arr[0]),sdsortfnc);
  if(arr[0].val>=6 || arr[2].val>=4){
    printf("Yes\n");
    return 0;
  }
  if(arr[0].val<=2){
