...
if(((sd*)a)->a < ((sd*)b)->a){return -1;}
if(((sd*)a)->a > ((sd*)b)->a){return 1;}
if(((sd*)a)->b < ((sd*)b)->b){return -1;}
if(((sd*)a)->b > ((sd*)b)->b){return 1;}
return 0;
}
...
int main(void){
  ...
  long long na=-llinf,nb=llinf,ls=0;
  ...
  for(i=0;i<n-1;i++){
    ...
    if(dat[i].b==nb){t=1;}
    if(t==0){continue;}
    r=llmax(llmax(0,query(0,ssize,0,0,ssize)-na+1)+llmax(0,nb-dat[i].a+1),r);
  }
  printf("%lld\n",r);
  return 0;
}
