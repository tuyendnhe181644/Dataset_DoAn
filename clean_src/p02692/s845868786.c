...
int main(){
    ...
    for(ll i = 0;i<N;i++){
        ...
        if((STR_EQ(S[i],"AB"))&&A==0&&B==0) {printf("No\n");return 0;}
        if((STR_EQ(S[i],"AC"))&&A==0&&C==0) {printf("No\n");return 0;}
        if(A+B+C == 0) {printf("No\n");return 0;}
            ...
            if(A==1&&B==1&&C==0&&i!=N-1){
                if(STR_EQ(S[i+1],"BC")){
                    B++;A--;ans[i]='B';continue;
                }else if(STR_EQ(S[i+1],"AC")){
                    B--;A++;ans[i]='A';continue;
                }
            }else if(B==1&&C==1&&A==0&&i!=N-1){
                if(STR_EQ(S[i+1],"AB")){
                    B++;C--;ans[i]='B';continue;
                }else if(STR_EQ(S[i+1],"AC")){
                    B--;C++;ans[i]='C';continue;
                }
            }else if(A==1&&C==1&&B==0&&i!=N-1){
                if(STR_EQ(S[i+1],"AB")){
                    A++;C--;ans[i]='A';continue;
                }else if(STR_EQ(S[i+1],"BC")){
                    A--;C++;ans[i]='C';continue;
                }
            }
            if((STR_EQ(S[i],"AB"))){
                if(A<B){A++;B--;ans[i]='A';}
