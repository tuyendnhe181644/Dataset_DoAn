...
typedef char string[100005];
typedef int array[100];
/*  define  */

/*  define funcs  */
#define sort_du(array,end){ll size=end-array;qsort(array,size,sizeof(ll),intcmp);}
#define sort_cu(array,end){int size=end-array;qsort(array,size,sizeof(char),charcmp);}
#define sort_dd(array,end){ll size=end-array;qsort(array,size,sizeof(ll),intcmp2);}
#define sort_cd(array,end){int size=end-array;qsort(array,size,sizeof(char),charcmp2);}
#define sort_ldu(array,end){ll size=end-array;qsort(array,size,sizeof(ll),longlongcmp);}
#define sort_ldd(array,end){ll size=end-array;qsort(array,size,sizeof(ll),longlongcmp2);}
...
int longlongcmp2(const void* a, const void* b);
...
int main(void){
	...
	ss(S);
	ll ans=0;
	rep(i,strlen(S)-1) if(S[i]!=S[i+1]) ans++;
	old(ans);
}
