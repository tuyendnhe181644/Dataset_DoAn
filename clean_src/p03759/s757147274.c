...
void core_io_printlnGcore_prelude_CStringG_core_prelude_CString(char* core_io_x) {
printf(core_io_x);
printf("\n");
}
void a1_mainGG_() {
int64_t a1_a = stdio_read_intGG_();
int64_t a1_b = stdio_read_intGG_();
int64_t a1_c = stdio_read_intGG_();
if ((((a1_b - a1_a)) == ((a1_c - a1_b)))) {
core_io_printlnGcore_prelude_CStringG_core_prelude_CString("YES");
} else {
core_io_printlnGcore_prelude_CStringG_core_prelude_CString("NO");
};
}
